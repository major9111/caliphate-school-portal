    ...
    <div className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div ref={headingRef} className="text-center mb-12">
          <h1 className="font-display font-bold text-4xl md:text-5xl mb-4 text-[var(--text)]">Gallery</h1>
          <p className="text-[var(--text-2)] max-w-2xl mx-auto">Photos from our classrooms, campus, and school life.</p>
        </div>
        ...
        {error && !loading && (
          <div className="flex flex-col items-center gap-3 py-16 text-[var(--text-2)]">
          ...
          <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {items.map((item) => (
              <button
                ...
                className="group text-left aspect-[3/4] rounded-2xl overflow-hidden shadow-soft border border-[var(--border)] relative"
              >
